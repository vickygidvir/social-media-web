    ...
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
      <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl'>
        ...
        <div className="h-full w-full lg:w-1/2  p-10 2xl:px-20 flex justify-center flex-col   ">
          ...
          <p className='text-ascent-1 text-base font-semibold'>Log into your account</p>
          ...
          <form className='py-8 flex flex-col gap-5' onSubmit={handleSubmit(onSubmit)}>
            ...
            <Link to="/reset-password" className='text-sm text-right text-blue font-semibold '>Forgot Password?
            </Link>
          ...
          <p className='text-ascent-2 text-sm text-center'>Don't have an account?
            <Link to="/register" className='text-[#065d8] font-semibold ml-2 cursor-pointer'>Create Account</Link>
          </p>
